...
import { deletePortfolioItem, getAllProfiles, getProfile,  updateProfile, uploadCoverImage, uploadProfilePhoto} from "../controller/Profile.controller.js";
...
router.post("/upload/profile-photo", authenticateUser, upload.single("image"),uploadProfilePhoto);
router.post("/upload/cover-image",authenticateUser,upload.single("image"), uploadCoverImage);
