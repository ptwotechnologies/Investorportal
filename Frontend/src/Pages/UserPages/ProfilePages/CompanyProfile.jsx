...
import CompanyProfileSec from '@/components/UserComponents/ProfileSec/CompanyProfile/CompanyProfileSec';
        ...
        <div className='bg-gray-100 min-h-screen'>
            <div className='max-w-[1600px] mx-auto w-full'>
                <div className='lg:flex'>
                    ...
                    <div className='flex-1 transition-all duration-300 mt-18 pt-1 lg:pt-0 lg:mt-0'>
                        <CompanyProfileSec/>
                    </div>
                </div>
            </div>
