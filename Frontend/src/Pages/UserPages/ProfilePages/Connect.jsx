import ConnectSec1 from '@/components/UserComponents/ProfileSec/ConnectSec/ConnectSec1'
    ...
    <div className='bg-gray-100 h-[calc(100dvh-60px)] lg:h-screen lg:relative fixed inset-0 flex flex-col overflow-hidden'>
      <div className='max-w-[1600px] mx-auto w-full flex-1 flex flex-col min-h-0'>
        <div className='flex flex-col lg:flex-row flex-1 min-h-0'>
          ...
          <div className='flex-1 flex flex-col min-h-0 transition-all duration-300 mt-13 lg:mt-0'>
            <ConnectSec1/>
          </div>
        </div>
      </div>
