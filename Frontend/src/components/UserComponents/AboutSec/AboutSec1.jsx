  ...
  return (
    <div className='pt-20  w-full lg:px-7 px-4 py-2 flex flex-col lg:flex-row justify-between items-center'>
     ...
     <div id='left' className=' lg:w-[50%] my-5 text-[#001032] lg:p-4 '>
      <h6 className='text-sm font-semibold lg:py-4 pt-3 pb-2'>About us</h6>
      <h1 className=' text-5xl lg:text-6xl font-semibold lg:leading-15  leading-12 tracking-wide '>Taking your </h1>
       <h1 className='text-5xl lg:text-6xl font-semibold  leading-15 tracking-wide pb-12 hidden lg:block'>Step to the next level </h1> 

       <h1 className='text-5xl lg:text-6xl font-semibold  lg:leading-15  leading-12 tracking-wide  lg:hidden'>Step to  </h1>
