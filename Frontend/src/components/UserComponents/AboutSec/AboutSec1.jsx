...
const AboutSec1 = () => {
  return (
    <div className='pt-20 w-full'>
      <div className="max-w-[1500px] mx-auto w-full px-4 lg:px-0 py-2 flex flex-col lg:flex-row justify-between items-center">
        ...
        <div id='right' className='w-full lg:w-[50%] lg:mt-28'>
          <div className='h-[220px] lg:h-[420px] bg-[#D8D8D8] lg:rounded-sm border'>
            <img src="/aboutpage1.png" alt="" className='w-full h-full lg:rounded-sm' />
            {/* <img src="/aboutpage2.png" alt="" className='w-full h-full '/> */}
          </div>
        </div>
      </div>
    </div>
