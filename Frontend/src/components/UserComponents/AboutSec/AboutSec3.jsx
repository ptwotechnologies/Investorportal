  ...
  return (
    <div className="lg:mt-16 lg:bg-[#00000040]  rounded-[70px]  lg:p-15 lg:px-13 text-white lg:pb-9 ">
      <div className="flex flex-col lg:flex-row justify-center items-center lg:gap-5">
        ...
        <h1 className="lg:bg-[#002A30] bg-[#616B80] lg:text-4xl text-3xl leading-9 lg:mx-14  font-medium lg:font-semibold lg:px-9 px-5 py-6">
          Where startups, experts and capital grow together
        </h1>
        <p className="text-md lg:text-2xl p-5 lg:p-7 lg:px-23 leading-7  tracking-wider lg:leading-snug lg:tracking-wide font-semibold lg:font-normal">
        ...
        <p className="text-md lg:text-2xl px-5 lg:p-3 lg:px-23 leading-7 tracking-wider lg:leading-snug lg:tracking-wide">
          We believe that ideas should not be held back by limited budget or
          lack of access.
        </p>
        <p className="text-md lg:text-2xl  px-5 lg:p-3 lg:px-23 leading-7 tracking-wider pb-3 lg:leading-snug lg:tracking-wide">
      ...
      <div id="right" className="lg:bg-[#616B80CC] bg-[#2C4E53CC] lg:rounded-sm pb-4 ">
        ...
        <h1 className="lg:bg-[#616B80] bg-[#2C4E52] lg:text-4xl text-3xl leading-9 lg:mx-14 font-semibold p-5 lg:px-9 py-6">
          Because founders deserve a better system
        </h1>
        <p className="text-md lg:text-2xl pt-5 lg:pt-7 pb-3 lg:pb-4 lg:px-20 lg:pl-23 p-5 font-semibold lg:font-normal leading-7 tracking-wider lg:leading-snug lg:tracking-wide">
          Our aim is to remove the friction that slows founders down and make
          growth feel more doable and less chaotic.
        </p>
        <p className="text-md lg:text-2xl lg:p-2 pb-2 lg:px-20 lg:pl-23 p-5 leading-7 tracking-wider lg:leading-snug lg:tracking-wide">
        ...
        <p className="text-md lg:text-2xl lg:p-2 lg:px-20 lg:pl-23 p-5 leading-7 tracking-wider lg:leading-snug lg:tracking-wide">
