...
const HomeSec1 = () => {
  ...
  return (
    <>
      <div className="bg-[#001032] h-290 md:h-auto lg:bg-white w-full pt-5 lg:pt-20  px-5 rounded-b-4xl">
        ...
        bg-linear-to-r from-[#001032] from-40% via-blue-[#001032] at-130% to-[#D8D8D8]"
              >
                ...
                <p className="text-center lg:hidden text-[12px]">
                  Designed for founders ready to grow with purpose
                </p>
              </div>
            </div>
            ...
            <div
              id="phone"
              className="lg:hidden text-white flex items-center gap-3  overflow-x-scroll  scrollbar-hide "
            >
              <div>
                ...
                <p className="py-3 h-25 text-sm font-light w-full">
                  Investors are already discovering founders like you
                </p>
              </div>
              <div>
                <div className="w-50 h-45 rounded-2xl bg-[#FFFFFF]">
                ...
                <p className="py-3 h-25 text-sm font-light w-full">
                  Access expert-led services at startup-first pricing
                </p>
              </div>
              <div>
                <div className="w-50 h-45 rounded-2xl bg-[#FFFFFF]">
                ...
                <p className="py-3 h-25 text-sm font-light w-full">
                  Get free advisory from mentors and venture experts
                </p>
              </div>
            </div>
          </div>
      ...
      <div
        className="flex justify-center items-center gap-2 border border-[#002A30]  w-[70%]  relative 
