...
who lived it first</h1>
             <p className="text-md  leading-7 tracking-wide mt-4 mb-10 w-[93%]">We’ve been through it — chasing investors, burning capital on ads, trusting agencies that never delivered. Most of it led nowhere.</p>
              <p className="text-lg  leading-7 tracking-wider " >That’s when we realized — </p>
               <p className=' text-lg  leading-7 tracking-wider w-[70%]'> the system was broken, not our ideas.</p>
