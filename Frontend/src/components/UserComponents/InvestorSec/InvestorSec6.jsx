...
import { HiOutlineUser, HiOutlineCircleStack, HiOutlineBuildingLibrary } from "react-icons/hi2";
            ...
            <div className="max-w-[1500px] mx-auto w-full  lg:!px-10 min-[1500px]:!px-0">
              ...
              <div className="relative">
                <div
                  ...
                  {cards.map((item, index) => (
                    <div key={index} className="w-full  lg:w-[30%] h-auto shrink-0 lg:p-4 lg:mx-2 lg:shadow-none ">
                      <div className=' w-full border border-[#00103280] lg:rounded-2xl shadow-lg rounded-sm lg:p-3 px-7 h-full min-h-[300px] lg:min-h-[280px] flex flex-col justify-between'>
              ...
              <div className='lg:text-center mt-10 '>
                ...
                lg:text-white p-2 lg:px-10 w-fit lg:mx-auto rounded-3xl lg:text-sm text-lg lg:hidden'>
                    If your investment approach fits any of these lanes and you prefer clearer, higher-quality deal flow, this platform is built for you.</h1>
