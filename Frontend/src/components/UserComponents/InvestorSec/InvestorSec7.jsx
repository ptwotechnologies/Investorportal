          ...
          <div className="flex  justify-center items-center gap-40 pt-15 ">
            <div id="left" className="w-[40%] ">
              <div className='text-[#001032] text-2xl  leading-8 tracking-wide '>
                ...
                <hr />
                <h1 className={`py-6 cursor-pointer transition-all ${activeStep === 2 ? 'font-medium' : 'opacity-70 hover:opacity-100'}`} onClick={() => setActiveStep(2)}>Create your investor profile, past deals & experience</h1>
                <hr />
                <h1 className={`py-6 cursor-pointer transition-all ${activeStep === 3 ? 'font-medium' : 'opacity-70 hover:opacity-100'}`} onClick={() => setActiveStep(3)}>Get verified in 24 hours</h1>
                <hr />
              ...
              <div className='flex justify-between items-center gap-15'>
                ...
                <p className='bg-[#D9D9D9] rounded-full p-6 text-5xl mr-10 mt-2'>{activeStep}/4</p>
              </div>
            </div>
      ...
      <div className='lg:hidden bg-[#002A30] p-10 px-5  rounded-sm text-white'>
        ...
        <div>
          <div className='w-10 h-10 bg-[#EEEEEE] my-6 lg:hidden'>
            ...
            <h1 className='text-2xl  pb-5'>Create your investor profile, past deals & experience</h1>
        ...
        <div>
          <div className='w-10 h-10 bg-[#EEEEEE] my-6 lg:hidden'>
            ...
            <h1 className='text-2xl pb-5'>Get verified in 24 hours</h1>
