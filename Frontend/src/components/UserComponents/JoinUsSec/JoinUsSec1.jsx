...
const JoinUsSec1 = () => {
  return (
    <div className='lg:bg-[#D8D8D880] text-white'>
      <div className="max-w-[1500px] mx-auto w-full lg:px-4 lg:!px-10 min-[1500px]:!px-0">
        <div className='bg-[#001032] lg:bg-transparent pt-8 px-2 lg:px-0'>
          <h1 className='lg:hidden mt-18 text-center mx-auto border border-white w-fit px-4 py-1 mb-2 rounded-full'>Join us</h1>
          <img src="/joinuspage1.png" alt="" className='w-full max-w-[1200px] h-[500px] mx-auto object-cover mt-30 hidden lg:block rounded-sm' />
          <div className='text-center w-full flex justify-center items-start lg:items-end lg:pb-15'>
            <div className='lg:w-[73%] lg:text-[#001032]'>
              <p className='text-[42px] font-semibold leading-13 lg:leading-12 tracking-wide mb-6 hidden lg:block mt-10'>Collaborate, grow, and accelerate opportunities on one unified platform</p>
              ...
              <Link to="/login"><button className='mt-3 lg:my-10 lg:bg-[#001426] lg:text-white bg-white text-[#001032] p-2 px-14 rounded-sm text-lg mb-35 lg:mb-0'>Get Listed</button></Link>
            </div>
          </div>
        </div>
