            ...
            <Card className="w-full h-full lg:h-auto mx-auto rounded-lg">
              <CardHeader>
                ...
                <CardDescription className=" mb-1 text-[#001032] text-lg lg:text-sm font-semibold  ">
                 ...
                 <p className="mt-2">We are reviewing your details. Please wait for 2 hours until it gets approved</p>
                </CardDescription>
              ...
              <CardFooter >
                ...
                <Link to="/selectPortal" className="w-full"><Button  className="w-full bg-[#001032] mt-5  mb-10 lg:mt-0 lg:mb-0">
                  Continue
                </Button></Link>
