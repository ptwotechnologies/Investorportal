...
const handleVerifyOtp = async () => {
  ...
  if (showSuccessCard) {
    return (
      <div className="flex justify-center items-center lg:min-h-screen p-4">
        <div className="max-w-[1600px] mx-auto w-full  lg:!px-10 min-[1500px]:!px-0 flex justify-center items-center">
  ...
  return (
    <div>
      <div className="max-w-[1600px] mx-auto w-full px-4 lg:!px-10 min-[1500px]:!px-0">
                ...
                <CardContent className="flex flex-col flex-grow">
                  <form onSubmit={handleSubmit} className="flex flex-col flex-grow">
                    ...
                    <CardFooter className="fixed bottom-0 left-0 w-full p-4 bg-white lg:relative lg:bg-transparent lg:p-0 lg:mt-auto lg:z-10">
                      <Button type="submit" className="w-full bg-[#001032] mt-2" disabled={isSubmitting}>
                        {isSubmitting ? (
