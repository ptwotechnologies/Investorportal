                  ...
                  <Link to="/subscription?tab=Marketing">
                   ...
                   <div className="text-[#001032] ml-3 font-medium">
                    ...
                    <div className=" h-44 mx-4 ">
                      <h1 className="text-[#001032]  text-[14px]">
                        Build a fundable & structured business 
                      </h1>
                      <p className="text-[#001032] tracking-wide leading-5 text-xs font-light">• Business Structuring (Pvt Ltd / LLP)</p>
                ...
                <NavigationMenuLink asChild>
                  <div className="border border-[#D0D0D040] inner-shadow rounded-xl p-2">
                    <div className="border border-[#D0D0D040] shadow-md rounded-xl p-3 text-center">
                      ...
                      <Link to="/joinus">
                        {" "}
                        <button className="bg-[#001032] text-white p-1 px-5  rounded-full">
                          Explore
                        </button>
                      </Link>
                    </div>
