    ...
    <div className="container mx-auto lg:p-10   ">
      ...
      <div className=''>
        ...
        {tabs.map((tab) => (
          <button
            key={tab.id}
            className={`lg:px-10 py-2 px-5 rounded  lg:text-2xl ${activeTab === tab.id ? 'bg-[#001426] text-white rounded-full p-2 px-5 lgpx-10' : ' text-white hover:bg-gray-300 hover:rounded-full '}`}
