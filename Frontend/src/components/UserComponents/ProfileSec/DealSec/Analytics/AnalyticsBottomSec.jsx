...
const AnalyticsBottomSec = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-2 lg:px-4 lg:py-2 bg-[#FDFDFF] xl:min-flex-1 min-h-0 overflow-hidden">
      {/* ── LEFT COLUMN ── */}
      <div className="flex-1 flex flex-col min-h-0 lg:py-2 gap-6 overflow-hidden">
        {/* Summary Cards Grid */}
        ...
        <h2 className="text-xl font-medium text-[#000000] px-1 shrink-0 px-2">
          Detailed Reports
        </h2>

        <div className="flex-1 min-h-0 overflow-y-auto scrollbar-hide p-2 w-[90%] lg:w-auto mx-auto">
          <div className="flex flex-col items-center gap-4 lg:p-8 p-5 text-center border border-gray-300 shadow-[0_4px_16px_rgba(0,0,0,0.15)] rounded-md bg-white w-full max-w-sm mx-auto lg:my-10">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Detailed insights and reports will appear here as you complete
                more deals.
              </p>
            </div>
          </div>
      ...
      <div className="w-full lg:w-[450px] xl:w-[550px] h-full flex flex-col overflow-hidden hidden lg:flex">
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden bg-white shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] border border-gray-100 m-2 rounded-2xl relative">
          <div className="flex-1 flex flex-col min-h-0 items-center justify-center h-full p-10 text-center opacity-50">
            ...
            <p className="text-sm text-gray-400 mt-1 italic">
              Select a report category from the left to see detailed insights.
            </p>
          </div>
        </div>
      </div>
