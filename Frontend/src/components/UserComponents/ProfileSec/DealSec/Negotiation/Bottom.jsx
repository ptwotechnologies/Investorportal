...
const Bottom = ({
  ...
  const fetchDeals = async (showLoading = true) => {
    ...
    try {
      ...
      const negotiatingDeals = allDeals.filter((d) =>
      ...
      if (selectedProject) {
        const updated = negotiatingDeals.find(
          (d) => d._id === selectedProject._id,
        );
  ...
  React.useEffect(() => {
    if (preselectedRequest) {
      setNewDealData((prev) => ({
        ...
        professionalId:
          preselectedRequest.acceptedProvider?._id ||
          preselectedRequest.acceptedProvider,
      }));
  ...
  const handleCreateProposal = async () => {
    ...
    if (newDealData.milestones.length === 0)
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-2 flex-1 min-h-0 lg:px-4 lg:py-2 bg-[#FDFDFF]">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-gradient-to-br from-[#EAE9FE] to-[#FFFFFF] shadow-[0px_0px_12px_0px_rgba(0,0,0,0.50)] px-3 py-4 lg:p-4 rounded-2xl flex flex-col justify-between min-h-[100px] border border-indigo-50">
              <div className="flex items-start gap-3">
                <div className="w-7 h-7 bg-white/60 rounded-lg flex items-center justify-center shrink-0 mt-0.5 shadow-sm border border-white">
                  <HiOutlineUserGroup size={18} className="text-[#001032]" />
                </div>
                <div className="flex flex-col gap-1 w-full">
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center gap-1 lg:gap-2 mt-1">
                    <p className="text-xl lg:text-2xl font-bold text-[#001032] leading-none">
                      {
                        deals.filter((d) => {
                          const uAgreed = isStartup
                            ? d.documentation?.startupAgreed
                            : d.documentation?.professionalAgreed;
                          const oAgreed = isStartup
                            ? d.documentation?.professionalAgreed
                            : d.documentation?.startupAgreed;
            ...
            <div className="bg-gradient-to-br from-[#FDF5E6] to-[#FFFFFF] shadow-[0px_0px_12px_0px_rgba(0,0,0,0.50)] px-3 py-4 lg:p-4 rounded-2xl flex flex-col justify-between min-h-[100px] border border-orange-50">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-white/60 rounded-lg flex items-center justify-center shrink-0 mt-0.5 shadow-sm border border-white">
                  <LuArrowLeftRight size={18} className="text-[#001032]" />
                </div>
                <div className="flex flex-col gap-1 w-full">
                  <h3 className="text-[13px] lg:text-sm lg:font-medium text-[#001032]">
                    Counter Offers
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center gap-1 lg:gap-2 mt-1">
                    <p className="text-xl lg:text-2xl font-bold text-[#001032] leading-none">
                      {deals.reduce(
                        (acc, d) => acc + (d.negotiation?.history?.length || 0),
                        0,
                      )}
                    </p>
            ...
            <div className="bg-gradient-to-br from-[#FDE8F1] to-[#FFFFFF] shadow-[0px_0px_12px_0px_rgba(0,0,0,0.50)] px-3 py-4 lg:p-4 rounded-2xl flex flex-col justify-between min-h-[100px] border border-pink-50">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-white/60 rounded-lg flex items-center justify-center shrink-0 mt-0.5 shadow-sm border border-white">
                  <LuClock size={18} className="text-[#001032]" />
                </div>
                <div className="flex flex-col gap-1 w-full">
                  <h3 className="text-[13px] lg:text-sm lg:font-medium text-[#001032]">
                    Expiring Soon
          ...
          <div className="flex items-center justify-between mt-2 mb-4 pr-2">
            <h2 className="text-xl font-medium text-[#000000] px-1">
              Proposals
            </h2>
          </div>
              ...
              <div className="bg-[#FFF9F1] rounded-2xl p-4 shadow-[0px_4px_12px_rgba(0,0,0,0.05)] border border-[#FFE0B2] space-y-3 mb-4 mx-1">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm font-medium text-[#455A64]">
                    3 professionals are interested
                  </p>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col items-center gap-4 lg:p-8 p-5 text-center border border-gray-300 shadow-[0_4px_16px_rgba(0,0,0,0.15)] rounded-md bg-white w-[90%] lg:w-auto max-w-sm mx-auto my-5 lg:my-10">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Your active negotiations and counter-offers will appear here.
                </p>
              </div>
            </div>
          ) : (
        ...
        {/* ── RIGHT COLUMN ── */}
        <div
          className={`lg:w-[450px] xl:w-[550px] mt-5 px-1 lg:px-0 lg:mt-auto flex flex-col flex-1 min-h-0 ${rightPanelState === "none" ? "hidden lg:block" : "flex"}`}
        >
          <div
            className={`transition-all duration-300 flex-1 min-h-0 flex flex-col relative overflow-hidden lg:px-2 p-1
 ${
 ...
 <FiX size={18} />
            ...
            {/* NO SELECTION STATE */}
            {rightPanelState === "none" && (
              <div className="flex-1 flex flex-col min-h-0 items-center justify-center text-center p-10 opacity-50 bg-white shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] border border-gray-100 rounded-2xl">
                ...
                <p className="text-sm text-gray-400 mt-1 italic">
                  Select a proposal from the left to view negotiation details.
                </p>
              </div>
            )}
            ...
            {rightPanelState === "create" && (
              <div className="flex-1 flex flex-col min-h-0 h-full overflow-hidden ">
                <div className="flex-1 min-h-0 overflow-y-auto scrollbar-hide p-2 space-y-4">
                  {!newDealData.requestId ? (
                    <div className="flex-1 flex flex-col min-h-0 items-center justify-center text-center p-10 opacity-50 bg-white shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] border border-gray-100 rounded-2xl h-full">
                      <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                      ...
                      <p className="text-sm text-gray-400 mt-1 italic">
                        Click the "Proposal" button in the Top Bar and select a
                        project to start.
                      </p>
                    </div>
                  ) : (
                    <>
                      ...
                      <div className="bg-white rounded-2xl lg:p-6 p-3 shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] border border-gray-100 relative">
                        <h4 className="text-[16px] font-medium text-[#000000] mb-2">
                          Scope of Work
                        </h4>
                        <textarea
                        ...
                        >
                          {newDealData.scopeItems.length > 0
                            ? "Edit Details"
                            : "Add Details"}
                        </button>
                      </div>
                      ...
                      <div className="bg-white rounded-2xl lg:p-4 p-3 shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] border border-gray-100">
                        <h4 className="text-[16px] font-medium text-[#000000] mb-4 ">
                          Total Budget
                        </h4>
                        <div className="flex gap-3">
                          <div className="w-[120px] px-3 py-2 bg-gray-50 rounded-lg text-[13px] lg:text-[10px] text-gray-400 border border-gray-100 flex items-center justify-center shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)]">
                            INR
                          </div>
                          <input
                            type="number"
                      ...
                      >
                        <div className="space-y-3 mt-4">
                          {newDealData.milestones.map((m, idx) => (
                            <div
                              key={idx}
                              className="bg-[#F8F8F8] rounded-xl p-3 relative flex items-center justify-between"
                            >
                              <div className="flex gap-3 items-start flex-1">
                                <div className="w-3 h-3 rounded-full bg-[#D8D6F8] mt-1 shrink-0" />
                                <div>
                                  <h5 className="text-[10px] font-bold text-[#000000]">
                          ...
                          {newDealData.milestones.length === 0 && (
                            <p className="text-[13px] text-gray-400 italic text-center py-2">
 ...
 <FiX size={18} />
                ...
                <div className="flex-1 min-h-0 overflow-y-auto scrollbar-hide p-2 relative space-y-4">
                  {/* Counter Proposal Workspace Alert */}
                  {(localStorage.getItem("debug_counter_proposal_trigger") ===
                    "true" ||
                    selectedProject?.isCounter ||
                    selectedProject?.negotiation?.history?.length > 0) &&
                    !isEditing && (
                      <div className="bg-gradient-to-r from-[#FFF4ED] to-[#FFEBE0] border border-[#FF6812]/20 rounded-2xl p-4 shadow-[0px_2px_8px_rgba(0,0,0,0.05)] mb-2 flex flex-col md:flex-row md:items-center justify-between gap-3 animate-in slide-in-from-top-2 duration-300">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-full bg-[#FF6812]/10 flex items-center justify-center shrink-0">
                            <span className="text-[#FF6812] text-lg">📝</span>
                          </div>
                          <div>
                            <h4 className="text-sm font-bold text-[#001032]">
                              Counter Proposal Received
                            </h4>
                            <p className="text-xs text-[#001032]/70 mt-0.5">
                              A revised proposal has been shared by the startup.
                            </p>
                          </div>
                        </div>
                        <button
                          onClick={() => {
                            localStorage.setItem(
                              "debug_counter_proposal_trigger",
                              "false",
                            );
                            setIsEditing(true);
                          }}
                          className="bg-[#FF6812] hover:bg-[#E55A0F] text-white text-xs font-bold py-2 px-4 rounded-xl shadow-sm transition-all whitespace-nowrap self-start md:self-auto"
                        >
                          Review Changes
                        </button>
                      </div>
                  ...
                  {/* Negotiation Momentum Workspace Alert */}
                  {(localStorage.getItem(
                    "debug_negotiation_momentum_trigger",
                  ) === "true" ||
                    selectedProject?.negotiation?.history?.length > 2) &&
                    !isEditing && (
                      <div className="bg-gradient-to-r from-[#F0FDF4] to-[#DCFCE7] border border-[#22C55E]/20 rounded-2xl p-4 shadow-[0px_2px_8px_rgba(0,0,0,0.05)] mb-2 flex flex-col md:flex-row md:items-center justify-between gap-3 animate-in slide-in-from-top-2 duration-300">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs font-normal text-[#001032]/70 mt-0.5">
                              This deal is progressing actively.
                            </p>
                          </div>
                        </div>
                        <button
                          ...
                          className="bg-[#22C55E] hover:bg-[#16A34A] text-white text-xs font-medium py-2 px-4 rounded-xl shadow-sm transition-all whitespace-nowrap self-start md:self-auto"
                        >
                  ...
                  <div className="space-y-4">
                    <div className="bg-white rounded-2xl p-4 shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] border border-gray-100">
                      ...
                      <div className="flex flex-col lg:flex-row gap-3">
                        <div className="lg:w-[150px] w-full px-4 py-2 bg-gray-50 rounded-lg text-xs text-gray-400 border border-gray-100 flex items-center justify-center shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)]">
                          INR - Indian Rupees
                        </div>
                        {isEditing ? (
                          ...
                          <div className="flex-1 px-4 py-2 bg-gray-50 rounded-lg text-xs text-gray-400 border border-gray-100 flex items-center justify-center shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] ">
                    ...
                    <div className="bg-white rounded-2xl p-4 shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] border border-gray-100 mt-4">
                      ...
                      <div className="flex flex-col lg:flex-row gap-3 mb-4">
                        ...
                        {isEditing ? (
                          ...
                          <div className="flex-1 px-4 py-2 bg-gray-50 rounded-lg text-xs text-gray-400 border border-gray-100 flex items-center justify-center shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] font-bold">
                  ...
                  <SectionCard title="Milestone" showPlus={isEditing}>
                    <div className="space-y-3 mt-4">
                      {(isEditing
                        ...
                        <div
                          key={m._id || m.id || idx}
                          className="bg-[#F8F8F8] rounded-xl p-2 lg:p-4 relative"
                        >
                          ...
                          >
                            ...
                            <div className="flex-1">
                              {isEditing ? (
                                ...
                                <>
                                  <h5 className="text-xs text-[#000000] font-medium">
                                    {m.title}
                                  </h5>
                                  <p className="text-[10px] text-gray-500 mt-1 leading-tight line-clamp-1">
                                    {m.description}
                                  </p>
                            ...
                            {isStartup &&
                              selectedProject?.documentation
                                ...
                                <div className="text-[10px] lg:text-xs font-semibold text-[#59549F] bg-[#D8D6F8]/30 py-1.5 px-3 rounded-lg flex items-center gap-2 animate-pulse">
                                  <IoMdCheckmark /> Professional has approved
                                  this deal
                                </div>
                              )}
                            {!isStartup &&
                              selectedProject?.documentation?.startupAgreed && (
                                <div className="text-[10px] lg:text-xs font-semibold text-[#59549F] bg-[#D8D6F8]/30 py-1.5 px-3 rounded-lg flex items-center gap-2 animate-pulse">
                                  <IoMdCheckmark /> Startup has approved this
                                  deal
                                </div>
                              )}
            ...
            {rightPanelState === "scopeDetails" && (
              <div className="flex-1 flex flex-col min-h-0 h-full overflow-hidden p-2">
                {!isEditing && (
                ...
                <div className="space-y-2 lg:p-3 px-3 py-3 -m-3 flex-1 min-h-0 overflow-y-auto scrollbar-hide">
            ...
            {rightPanelState === "milestoneDetails" && selectedMilestone && (
              <div className="flex-1 flex flex-col min-h-0 h-full overflow-hidden">
                ...
                <div className="space-y-6 flex-1 min-h-0 overflow-y-auto scrollbar-hide p-2">
                  ...
                  <div className="bg-white border border-gray-100 rounded-2xl lg:px-6 px-3 py-3 shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)]">
                    ...
                    <div className="flex flex-col lg:flex-row gap-3 mb-2">
                      <div className="lg:w-[150px] w-full px-3 py-2 bg-[#FDFDFF] border border-gray-100 rounded-lg text-[13px] lg:text-[10px] text-gray-400 whitespace-nowrap text-center shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)]">
                        INR - Indian Rupees
                      </div>
                      <input
                        type="number"
                  ...
                  <div className="pt-2">
                    <h4 className="text-base font-medium text-[#000000] mb-4 ">
                      Scope of work in {selectedMilestone.title || "milestone"}
                    </h4>
                    <textarea
                    ...
                    <button
                      onClick={() => {
                        ...
                        if (prevPanelState === "create") {
                          const exists = newDealData.milestones.findIndex(
                          ...
                          const exists = editedDeal.milestones.findIndex(
                            (m) =>
...
const ProposalCard = ({ proj, selectedProject, handleViewProject }) => {
  ...
  const hoursElapsed = (now - createdDate) / (1000 * 60 * 60);
  const showNudge =
    hoursElapsed >= 24 && !["Approved", "Active"].includes(proj.status);
  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 gap-2 lg:gap-2 mb-4 items-start">
        ...
        <div className="col-span-3 mt-1 flex justify-between items-end">
          <p className="text-[13px] lg:text-sm text-[#000000] ">{userName}</p>
          {/* Fast Responder Trigger Badge */}
          {(!isStartup ||
            localStorage.getItem("debug_fast_responder_trigger") ===
              "true") && (
            <div className="bg-[#FFF4ED] border border-[#D7C7BA] text-[#4A4A4A] text-[10px] lg:text-[10px] px-3 py-1 rounded-full shadow-[inset_0px_0px_8px_0px_rgba(0,0,0,0.1)] shrink-0 font-medium">
              Fast Responder
            </div>
          )}
        </div>
      ...
      {!isStartup && showNudge && (
        <div className="bg-[#FFF9F1] rounded-2xl p-4 mb-1 flex items-start gap-3 border border-[#FFE0B2] shadow-sm">
          ...
          <div className="flex flex-col">
            <h4 className="text-sm font-semibold text-[#000000] mb-1 lg:mb-2">
              This deal is close to finalization
            </h4>
            <p className="text-[10px] text-gray-500 leading-tight">
              Finalize now to secure the professional
            </p>
          </div>
        </div>
      )}
