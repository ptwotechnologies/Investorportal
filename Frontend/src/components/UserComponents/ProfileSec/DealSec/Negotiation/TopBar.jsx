...
const TopBar = ({ setRightPanelState, onProjectSelect }) => {
  ...
  const toggleDropdown = () => {
    ...
    const menu = document.getElementById('negotiation-proposal-dropdown');
  ...
  return (
    <div className="bg-white px-2.5 lg:px-6 lg:pt-6 pt-4 pb-3 ">
      <RequestGuideModal 
        ...
        title="Ready to Create a Proposal?"
      />
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-6">
        ...
        <div className="flex-shrink-0 text-left w-full lg:w-auto">
          <h1 className="text-2xl font-medium text-[#001032] leading-tight">Negotiations</h1>
        ...
        <div className="flex items-center gap-2 lg:gap-6 w-full lg:flex-1 lg:justify-end">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-[13px] lg:text-lg whitespace-nowrap">Proposal</span>
            </button>

            {/* Dropdown Menu */}
            <div 
              id="negotiation-proposal-dropdown"
            ...
            >
              <div className="p-2 border-b border-gray-50 bg-gray-50/50">
                <span className="text-sm text-black font-medium tracking-wider px-2">Select Project for Proposal</span>
              </div>
