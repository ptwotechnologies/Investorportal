  ...
  const fetchDeals = async () => {
    ...
    try {
      ...
      const revenueDeals = allDeals.filter((d) => {
        const profIdStr = d.professionalId?._id
          ? String(d.professionalId._id)
          : typeof d.professionalId === "string"
            ? d.professionalId
            : String(d.professionalId);
        ...
        return (
          (isVerifiedByMe || isOfficiallyReady) && isProfessionalOfThisDeal
        );
      });
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-2 px-1 lg:px-4 lg:py-2 bg-[#FDFDFF] flex-1 min-h-0 overflow-hidden">
      ...
      >
        ...
        <h2 className="text-xl font-semibold text-[#001032] px-1 shrink-0">
          Revenue Overview
        </h2>
            ...
            <div className="flex flex-col items-center gap-4 p-5 lg:p-8 text-center border border-gray-300 shadow-[0_4px_16px_rgba(0,0,0,0.15)] rounded-md bg-white w-[90%] lg:w-auto max-w-sm mx-auto lg:my-10">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Your earnings and payment releases will appear here.
                </p>
              </div>
            </div>
          ) : (
      ...
      {/* ── Right Column ── */}
      <div
        className={`flex-1 h-full flex flex-col gap-4 ${selectedDeal ? "flex" : "hidden lg:flex"}`}
      >
        {selectedDeal && (
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden bg-white shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)] border border-gray-100 m-2 rounded-2xl relative">
          <div className="flex-1 min-h-0 overflow-y-auto scrollbar-hide relative">
            {selectedDeal ? (
              <div className="flex-1 flex flex-col min-h-0 p-4 lg:p-6 space-y-6">
                  ...
                  <div className="space-y-4">
                    {selectedDeal.milestones?.map((m, idx) => (
                      <div
                        ...
                        className={`bg-[#F9F9FF] rounded-xl p-2 lg:p-4 border transition-all ${selectedMilestone?._id === m._id ? "border-[#D8D6F8] shadow-md" : "border-gray-100 shadow-[inset_0px_0px_8px_0px_rgba(0,0,0,0.05)]"} flex items-center justify-between cursor-pointer`}
                      >
                        <div className="flex gap-3 overflow-hidden">
                          <div
                            className={`w-3 h-3 rounded-full mt-1 shrink-0 ${m.status === "Paid" ? "bg-green-400" : "bg-gray-200"}`}
                          />
                        ...
                        <div
                          className={`text-[10px] font-bold px-3 py-1.5 rounded-md shadow-sm whitespace-nowrap ml-2 ${m.status === "Paid" ? "bg-green-50 text-green-600 border border-green-100" : "bg-gray-100 text-gray-400"}`}
                        >
                      ...
                      <div className="grid grid-cols-3 gap-1 lg:gap-3 lg:mb-3 my-3">
                        ...
                        <div className="bg-[#F5F5F5] rounded-xl lg:rounded-2xl p-1 py-3 lg:p-3 flex flex-col items-center justify-center space-y-1 lg:space-y-2 shadow-[inset_0px_0px_8px_0px_rgba(0,0,0,0.15)] text-center">
                          ...
                          <p className="text-[13px] lg:text-lg text-gray-400 font-bold">
                            Rs {milestoneBreakdown.fee + milestoneBreakdown.gst}
                          </p>
                        </div>
                        <div className="bg-[#EEECFD] rounded-xl lg:rounded-2xl p-1 py-3 lg:p-3 flex flex-col items-center justify-center space-y-1 lg:space-y-2 shadow-[inset_0px_0px_8px_0px_rgba(0,0,0,0.15)] text-center">
                          <p className="text-[9px] lg:text-[10px] text-[#000000] leading-tight">
                          ...
                          <p className="text-[13px] lg:text-lg text-[#59549F] font-bold">
                            Rs {milestoneBreakdown.received}
                          </p>
                        </div>
                      </div>
              ...
              <div className="h-full flex flex-col items-center justify-center text-center p-10 opacity-50">
                ...
                <p className="text-sm text-gray-400 mt-1 italic">
                  Select a deal to view revenue details
                </p>
              </div>
            )}
          </div>
