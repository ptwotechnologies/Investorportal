...
const StartupSec1 = () => {
  return (
    <div
      className="pt-60 lg:pt-15 w-full lg:px-6 min-[1400px]:!pt-19 px-4 py-2 flex flex-col  justify-center items-center gap-5 h-[800px] lg:h-auto rounded-b-2xl lg:rounded-none
