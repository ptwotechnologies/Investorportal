  ...
  return (
    ...
    <div className="mt-15  hidden  lg:block">
      ...
      <div className="max-w-[1500px] mx-auto w-full">
        <div className=" lg:!m-10 min-[1400px]:!mx-0">
          ...
          <div className="flex justify-evenly items-center gap-20">
            <div className="flex justify-center items-center gap-15 lg:mx-10 min-[1400px]:!mx-5 ml-35">
              <div className="w-[18%] ">
    ...
    <div id="phoneScreen" className="border rounded-2xl text-white flex flex-wrap gap-x-4 gap-y-16  justify-center mt-1 py-8 pt-40  lg:hidden">
      <div className="max-w-[1500px] mx-auto w-full flex flex-wrap gap-x-4 gap-y-16 justify-center">
