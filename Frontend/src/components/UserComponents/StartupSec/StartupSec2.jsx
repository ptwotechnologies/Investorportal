...
const StartupSec2 = () => {
  return (
    ...
    <div className="mt-15  hidden  lg:block">
      <hr />
      <div className=" m-10">
        <h1 className='mb-15 mt-20 text-4xl text-[#001032] font-bold leading-11 tracking-wider'>The startup ecosystem</h1>
        <div className="flex justify-evenly items-center gap-20">
          <div className="flex justify-center items-center gap-7 mx-10 ml-35">
            <div className="w-[18%] ">
