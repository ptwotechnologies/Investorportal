...
const StartupSec5 = () => {
  ...
  return (
    <>
    <div className='bg-linear-to-t from-[#002A30] to-[#001032] from-40% text-white lg:mt-25 lg:my-10 mt-5 py-7  rounded-sm lg:rounded-none p-5 shadow-2xl lg:shadow-none' >
    ...
    <div className='shadow-2xl p-7 pt-8 m-2 lg:hidden text-center '>
      ...
      <h1 className='text-md mt-2 text-[#001032]'>Let’s turn it into <br/>
