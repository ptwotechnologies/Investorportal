    ...
    <div className='lg:pt-40 w-full lg:px-6 px-4 py-2 flex flex-col justify-center items-center gap-5 h-[880px] lg:h-auto rounded-b-2xl lg:rounded-none'>
      <div className="max-w-[1600px] mx-auto w-full flex flex-col justify-center items-center gap-5">
        ...
        <div id='left' className='w-full text-center lg:text-[#001032]'>
          ...
          <Link to="/login"><button className='mt-7 lg:bg-[#001032] lg:text-white bg-white text-[#001032] p-2 px-10 rounded-sm text-lg drop-shadow-[0_6px_2px_rgba(0,0,0,0.2)] lg:drop-shadow-none mb-5'>Register</button></Link>
        </div>
        <div id='right' className='w-full my-5 lg:my-0 lg:w-[80%] min-[1450px]:w-full'>
          <div className='relative h-80 lg:h-[300px] min-[1400px]:!h-[600px] lg:rounded-sm rounded-2xl flex justify-center items-end overflow-hidden shadow-md lg:shadow-none'>
